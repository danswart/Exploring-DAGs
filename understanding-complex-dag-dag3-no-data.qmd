...
ggdag(causal_salad_dag3) + 
  theme_dag() +
  label("DAG: Complex Structure with Multiple Causal Pathways")
...
# Create a nice visualization of the DAG
dag_plot <- ggdag(causal_salad_dag3) + 
  theme_dag() +
  label("DAG: Complex Structure with Multiple Causal Pathways")
...
complex_dag_tidy <- tidy_dagitty(complex_dag)

# Status plot showing exposure/outcome
ggdag_status(complex_dag_tidy) +
  theme_dag() +
  label("Status Plot: Exposure and Outcome")

# Adjustment set visualization
ggdag_adjustment_set(complex_dag_tidy) +
  theme_dag() +
  label("Adjustment Sets for X → Y")

# Paths visualization
ggdag_paths(complex_dag_tidy) +
  theme_dag() +
