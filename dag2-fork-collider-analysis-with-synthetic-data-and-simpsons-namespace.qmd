...
fork_collider_dag_viz <- DiagrammeR::grViz("
  digraph DAG {
    # Graph settings
...
# Set coordinates for visualization - NOTE: coordinates is a dagitty function!
...
Z <- round(Z, 3)  # Round to 3 decimal places
...
corrplot::corrplot(
  ...
  tl.col = "darkblue", 
  tl.srt = 45,
  col = grDevices::colorRampPalette(c("white", "lightgreen", "pink", "orange", "lightblue"))(5),
  diag = TRUE,
...
ggplot2::ggplot(dag_data, ggplot2::aes(x = X, y = Y, color = C_strata)) +
  ...
  ggplot2::labs(
    title = "X-Y Relationship Stratified by C (Collider)",
...
ggplot2::ggplot(
  ...
  ggplot2::scale_color_manual(values = c("red", "darkgreen", "red")) +
  ggplot2::labs(
